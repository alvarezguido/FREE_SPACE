...
#multi_nodes = [2,5,7,10,12,15,18,20,24]
#multi_nodes = [5]
#multi_nodes = [500]
#############################################################
# =============================================================================
...
#     fname = "./LB1_1CH/" + str("LB1_"+str(nrNodes)+"_1CH_"+str(maxBSReceives)) + ".csv"
...
for nrNodes in multi_nodes:
    ...
    fname = "./LB1_3CH/" + str("LB1_"+str(nrNodes)+"_3CH_"+str(maxBSReceives)) + ".csv"
    with open(fname,"w") as myfile:
        myfile.write("\n".join(logs))
    myfile.close()
    i=i+1
