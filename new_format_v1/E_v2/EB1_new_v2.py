...
multi_nodes = [1400,2000,2500,3000,3500,4000,4500,5000,6000]
...
distance = np.concatenate((distance,distance,distance,distance))
Lpl = np.concatenate((Lpl,Lpl,Lpl,Lpl))
Prx = np.concatenate((Prx,Prx,Prx,Prx))
...
for nrNodes in multi_nodes:
    ...
    fname = "./EB1_1CH/" + str("EB1_"+str(nrNodes)+"_1CH_"+str(maxBSReceives)) + ".csv"
...
for nrNodes in multi_nodes:
    ...
    fname = "./EB1_3CH/" + str("EB1_"+str(nrNodes)+"_3CH_"+str(maxBSReceives)) + ".csv"
    with open(fname,"w") as myfile:
        myfile.write("\n".join(logs))
    myfile.close()
    i=i+1
